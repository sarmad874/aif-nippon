...
## Environments
- Preview: https://main--aif-nippon--sarmad874.aem.page/
- Live: https://main--aif-nippon--sarmad874.aem.live/
...
1. Open the `aif-nippon` directory in your favorite IDE and start coding :)
